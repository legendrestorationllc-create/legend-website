...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      {hovered && (
        <span style={{
          position: 'absolute', right: 64, bottom: '50%', transform: 'translateY(50%)',
          background: 'rgba(0,0,0,.8)', color: 'white', borderRadius: 6,
          padding: '0.375rem 0.75rem', fontSize: '0.8125rem', whiteSpace: 'nowrap',
          fontFamily: 'var(--font-dm)', pointerEvents: 'none',
        }}>
          {t.whatsapp.tooltip}
        </span>
      )}
